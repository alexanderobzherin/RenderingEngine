...
VkImageView RenderingApplication::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void RenderingApplication::CreateDepthResources()
{
    ...
    CreateVulkanImage(mSwapChainExtent.width, mSwapChainExtent.height, depthFormat, 
