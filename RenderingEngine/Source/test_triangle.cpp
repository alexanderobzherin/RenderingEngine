...
namespace rendering_engine
{
    ...
    void TestTriangle::Initialize(VulkanRenderer* renderer)
    {
        mRenderer = renderer;
    ...
    void TestTriangle::Update(float deltaTime)
    {
    }
	...
	void TestTriangle::CreateGraphicsPipeline()
	{
        auto spvVert = Utility::ReadShaderBinaryFile("../Intermediate/Shaders/TestTriangle/TestTriangle_vert.spv");
        auto spvFrag = Utility::ReadShaderBinaryFile("../Intermediate/Shaders/TestTriangle/TestTriangle_frag.spv");
