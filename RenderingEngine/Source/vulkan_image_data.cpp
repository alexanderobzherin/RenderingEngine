...
void VulkanImageData::Initialize()
{
    CreateTextureImage();
...
VkImage VulkanImageData::GetVulkanTextureImage()
{
    return mTextureImage;
}

VkImageView VulkanImageData::GetVulkanTextureImageView()
{
    return mTextureImageView;
}

VkDeviceMemory VulkanImageData::GetVulkanTextureImageMemory()
{
    return mTextureImageMemory;
}

std::uint32_t VulkanImageData::GetMipmapLevels()
{
    return mMipmapLevels;
}

VkSampler VulkanImageData::GetTextureSampler()
{
...
void VulkanImageData::CreateVulkanImage(uint32_t width, uint32_t height, std::uint32_t mipmapLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
void VulkanImageData::CreateTextureImageView()
{
    mTextureImageView = CreateImageView(mTextureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mMipmapLevels);
}

VkImageView VulkanImageData::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, std::uint32_t mipmapLevels)
{
...
void VulkanImageData::CreateTextureSampler()
{
